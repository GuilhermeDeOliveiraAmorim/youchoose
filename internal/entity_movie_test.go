...
func TestNewMovie(t *testing.T) {
	...
	_, err = NewMovie("", Nationality{"United States", "🇺🇸"}, []Genre{{Name: "Sci-Fi"}}, []Director{{Name: "Christopher Nolan"}}, []Actor{{Name: "Leonardo DiCaprio"}}, []Writer{{Name: "Christopher Nolan"}}, 2010, "image123")
	if err == nil {
