...
func TestCreateMovieUseCase_Execute(t *testing.T) {
	...
	mockGenreRepo.EXPECT().CreateMany(gomock.Any()).Return(nil)
	mockMovieActor.EXPECT().CreateMany(gomock.Any()).Return(nil)
	mockActorRepo.EXPECT().CreateMany(gomock.Any()).Return(nil)
	mockMovieDirector.EXPECT().CreateMany(gomock.Any()).Return(nil)
	mockDirectorRepo.EXPECT().CreateMany(gomock.Any()).Return(nil)
	mockMovieWriter.EXPECT().CreateMany(gomock.Any()).Return(nil)
	mockWriterRepo.EXPECT().CreateMany(gomock.Any()).Return(nil)
