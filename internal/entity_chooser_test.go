...
func TestNewChooser(t *testing.T) {
	name := "John Doe"
	login := &Login{Email: "john@example.com", Password: "P@ssw0rd"}
...
func TestChangeLogin(t *testing.T) {
	oldLogin := &Login{Email: "old@example.com", Password: "OldP@ssw0rd"}
	newLogin := &Login{Email: "new@example.com", Password: "NewP@ssw0rd"}
